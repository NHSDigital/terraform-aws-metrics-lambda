...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="sonar-reports",
        description="converts junit xml and coverage reports to the right format for sonarqube",
        epilog="expects reports/junit/*.xml or reports/coverage.xml and outputs to reports/sonar/",
    )
